...
service.saveState(NarrativeRuntime_1.NarrativeRuntime.createInitialState());
...
run('trama.player-intervention.success', () => api.advanceTrama('trama.main.coverage-2', 'Intervention joueur réussie'));
...
run('companion.recruit', () => api.recruitCompanion('companion.main.coverage-1', 'Accord social validé + coût d\'engagement accepté'));
...
run('trade.haggle.success', () => api.haggleTrade('trade.main.coverage-1', 'Argumentaire réussi dans les bornes système'));
