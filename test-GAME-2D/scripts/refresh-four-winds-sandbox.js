...
layout.simulation.factions = [
  {
    ...
    methods: ["negociation", "escorte", "pression economique"], objectiveHints: ["open_route", "take_control_place", "acquire_resource"], tags: ["trade", "civic", "western_reach"],
  ...
  {
    id: "red_knives", label: "Couteaux Rouges", type: "criminal_network", color: "#c96f4a",
    ...
    methods: ["extorsion", "contrebande", "recrutement"], objectiveHints: ["acquire_resource", "recruit_agents", "weaken_rival"], tags: ["criminal", "cross_border", "western_reach"],
  ...
  },
  {
    ...
    methods: ["patrouille", "escorte", "pression militaire"], objectiveHints: ["open_route", "eliminate_threat", "take_control_place"], tags: ["military", "civic", "eastern_marches"],
    ...
    localAnchors: [
      ...
      { id: "dawn_guard:frontier_depot", label: "Depot de la Ligne Frontaliere", type: "outpost", targetKind: "route", targetId: "frontier_supply_track", level: 3, tags: ["logistique", "military", "relais"], notes: "Relais de secours qui empile fourrage, vivres et munitions." }
    ],
  ...
  },
  {
    ...
    methods: ["enquete", "pelerinage", "secret"], objectiveHints: ["search_object", "protect_secret", "extend_influence"], tags: ["religious", "ashen_hills", "cross_border"],
    ...
    localAnchors: [
      { id: "ember_cult:ash_monastery", label: "Monastere des Cendres", type: "temple", targetKind: "district", targetId: "ironvale:pilgrim_steps", level: 4, tags: ["rite", "sanctuary", "religious"], notes: "Maison-mere du culte et lieu de conservation des archives rituelles." },
