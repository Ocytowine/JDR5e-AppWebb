...
- Le front charge `src/data/actions/index.json` et filtre selon la fiche de l'entite.

Structure
- src/data/models/action-model.json: modele a copier pour creer une nouvelle action.
- src/data/actions/index.json: liste des actions chargees (chemins relatifs).
- src/data/:
  - attacks/: attaques, projectiles, melee.
  - moves/: deplacements, dash, etc. (types dans `moves/types`)
  - supports/: soins, buffs, defausses.
