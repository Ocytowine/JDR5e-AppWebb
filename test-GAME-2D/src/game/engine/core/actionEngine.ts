...
import { compileActionPlan } from "./actionCompile";
import { executePlan } from "./actionExecute";
import { actionDefinitionToActionSpec } from "./actionAdapter";
import { hasLineOfEffect } from "../../../lineOfSight";
import type { WallSegment } from "../../map/walls/types";
import { getHeightAtGrid, type TerrainCell } from "../../map/generation/draft";
import { isEdgeBlockedForMovement } from "../../map/walls/runtime";
import { getClosestFootprintCellToPoint } from "../runtime/footprint";
import { metersToCells } from "../runtime/units";
